    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          edad: data.edad || '',
          sexo: data.sexo || '',
          tamano: normalizarTamano(data.tamano) || '',
          descripcion: data.descripcion || '',
          estadoSalud: data.estadoSalud || '',
          foto: data.foto || '',
          statusPublicacion: data.statusPublicacion || 'DISPONIBLE',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(typeof data === 'string' ? data : (data.message || 'Error al actualizar la mascota'));
      }
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-light text-gray-800 mb-2">Editar Mascota</h1>
          <p className="text-gray-500">Actualiza la información de la mascota</p>
        </div>
        ...
        <Card className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {formData.foto && (
                <div className="mt-2">
                  <img src={formData.foto} alt="Preview" className="w-32 h-32 object-cover rounded-lg" onError={(e) => e.target.style.display = 'none'} />
                </div>
              )}
            </div>
